...
I5V官：想了解应聘者之前公司接触的 ES 使用场景、规模，有没有做过比较大规模的索引设计、规划、调优。
...
上面的提及一部分，I5V者就基本对你之前的实践或者运维经验有所评估了。
...
I5V官：想了解 ES 集群的底层原理，不再只关注业务层面了。
...
I5V官：想了解 ES 搜索的底层原理，不再只关注业务层面了。
...
G:源地址：https://mp.weixin.qq.com/s?src=11&timestamp=1609687695&ver=2806&signature=FcV75ZX1wfmxokDnfOwc-Ermkji*mCgl-9WAlgsbo89iDQNXvZ91ishCuTHdopSg5Ih9VCtz2RnomdKT-*3mH4h1ea1GkfJPR1N7XIssZdihHzhrj1rcgbMuwHE3UXHQ&new=1
图片仍需处理